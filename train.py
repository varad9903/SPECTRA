...
if __name__ == '__main__':
    ...
    # NOTE: Removed forced LAST_LAYER='transformer' override.
    # The architecture (including refiner) should stay as configured in the YAML.
    # Only the loss components change during ablation experiments.
    ...
    if cfg.MODEL.DIST_TRAIN:
        import sys
        # Universal fallback for single-process environments (e.g. standard python command)
