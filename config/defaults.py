...
_C.MODEL.MEMORY_BANK_SIZE=4096
_C.MODEL.ORTHO_WEIGHT=0.1

# PACR (Prototype-Anchored Contrastive Refinement) loss settings
...
# CrossAttentionRefiner settings (learned ANFC replacement)
_C.MODEL.USE_REFINER = False
_C.MODEL.REFINER_HEADS = 8
_C.MODEL.REFINER_DROPOUT = 0.1

# Self-Distillation (NFC-as-Teacher) settings
...
# Neighbor Feature Centralization (NFC) - test-time enhancement
# NFC_MODE: 'adaptive' (ANFC v2), 'fixed' (original Pose2ID with k1/k2), 'none' (disabled)
_C.TEST.NFC_MODE = 'adaptive'
_C.TEST.NFC_K1 = 2
_C.TEST.NFC_K2 = 2
# ANFC v2 settings
_C.TEST.NFC_ALPHA = 0.7
_C.TEST.NFC_MAX_K = 20
# NFC_APPLY_TO: 'both' (query+gallery), 'query_only', 'gallery_only'
